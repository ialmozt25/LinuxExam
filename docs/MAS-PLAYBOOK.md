...
|---|---|---|---|
| manage_software_2026-09-25 | 1/6 | 5 | false |
| manage_software_2026-09-26 | 4/6 | 7 (bias) | false |
| manage_software_2026-09-27 | 3/6 | 0 | false (старый критерий) |
| manage_software_2026-09-28 | 4/6 | 2 | false |

При новом критерии (§4) 27.09 был бы accepted.

**Примечание (сверка с логами прогона 27.09).** В голосовании 27.09
...
`ru_editor == PASS`, поэтому по логам прогон 27.09 остаётся **не принятым**;
...
для 25.09 подтверждены блокеры ms_002–ms_005.
