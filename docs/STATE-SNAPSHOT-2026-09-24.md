> **Примечание от 2026-09-25:** на момент составления снимка файл журнала решений
> назывался `docs/DECISIONS.md`. 2026-09-25 он переименован в
> `docs/ENGINEERING-DECISIONS.md` (см. .project/DECISIONS.md). Упоминания
> `DECISIONS.md` ниже относятся к этому файлу.
